                            ...
                            <div>
                                ...
                                <div class="d-flex" style="gap: 24px;">
                                    <div style="margin-bottom: 5px; width: 100%;">
                                        ...
                                        <input type="text" name="detail" id="detail" autocomplete="off" required placeholder="Rusak / Exp / etc" class="form-control">
                                    </div>
                                    <div style="margin-bottom: 5px; width: 100%;">
                                ...
                                <div class="modal-footer d-flex justify-content-end">
                                    <button name="out_add" type="submit" class="btn btn-primary">Save</button>
                                </div>
                        </form>
                    </div>
                </div>
