...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="<?= base_url()  ?>assets/index2.html"><b>Quick</b>Sale</a>
        </div>

        <div class="register-box-body">
            <p class="login-box-msg">Register a new Cashier</p>
            ...
            <form action="<?= base_url('auth/register') ?>" method="post">
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <a href="<?= base_url('auth') ?>" class="text-center">I already have a Cashier</a>
